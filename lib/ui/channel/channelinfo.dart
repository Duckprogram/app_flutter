...
class ChannelInfo extends StatefulWidget {
  ChannelInfo({Key? key, required this.channel}) : super(key: key);
...
class _ChannelInfoState extends State<ChannelInfo> {
  ...
  //       builder: (context) => ChannelHome(channel: _channel)));
  // }
  ...
  Widget build(BuildContext context) {
    Widget channelintroduce = Container(
        ...
        child: Column(
          ...
          children: [
            Text("채널 소개", style: channelName),
            Padding(padding: const EdgeInsets.all(10)),
            Text(_channel?.introduction.toString() ?? "데이터를 불러오는 중 입니다.",
                style: body2),
            Padding(padding: const EdgeInsets.all(10)),
            Container(
    ...
    Widget channelrule = Container(
        ...
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            Text("채널 규칙", style: channelName),
            Padding(padding: const EdgeInsets.all(10)),
            Text(_channel?.rule.toString() ?? "데이터를 불러오는 중 입니다.",
                style: body2),
            Padding(padding: const EdgeInsets.all(10)),
          ],
        ));
